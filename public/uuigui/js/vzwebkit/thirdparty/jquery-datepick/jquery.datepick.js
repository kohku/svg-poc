...
function Datepicker() {
	...
	this.regional[''] = { // US/English
		...
		prevText: '<div title="Previous" class="prev"></div>', // Text for the previous month command
		prevStatus: 'Show the previous month', // Status text for the previous month command
		prevJumpText: '&lt;&lt;', // Text for the previous year command
		prevJumpStatus: 'Show the previous year', // Status text for the previous year command
		nextText: '<div title="Next" class="next"></div>', // Text for the next month command
...
$.extend(Datepicker.prototype, {
	...
	defaultRenderer: {
		...
		month: '<div class="datepick-month"><div class="datepick-month-header">{link:prev}<div class="monthhdr">{monthHeader}</div>{link:next}</div>' +
